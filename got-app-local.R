# got-app-local.R ==> INTERACTS WITH LOCAL FOLDER ON MACHINE
...
shinyApp(
  ...
  server = function(input, output, session) {
    ...
    # Save the data! Want to give each file a unique file name:
    #  + Concatenate save timestamp and data (the only way data would overwrite one another
    #      is if data for that record are identical, AND submitted simultaneously)
